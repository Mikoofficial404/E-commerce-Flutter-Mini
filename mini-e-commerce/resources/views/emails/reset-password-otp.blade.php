...
<head>
  ...
  <div class="container">
    <div class="header">
      <a>Prove Your KlikMart Identity</a>
    </div>
    <br />
    <strong>Dear {{ $username }}!,</strong>
    <p>
      We have received a login request for your KlikMart account. For
    ...
    <p style="font-size: 0.9em">
      ...
      <br />
      <br />
      <strong>Thank you for using KlikMart.</strong>
      <br />
      <br />
      Best regards,
      <br />
      <strong>KlikMart</strong>
    </p>
    ...
    <div class="footer">
      ...
      <p>
        For more information about KlikMart and your account, visit
  ...
  <div style="text-align: center">
    <div class="email-info">
      <span>
        ...
        <a href="mailto:{Email Adress}">klikMart@bussnies.com</a>
      </span>
    </div>
    <div class="email-info">
      <a href="/">KlikMart</a> | Jalan Warga 1 
      | JatiRanggon - 701123 , Indonesia
    </div>
    <div class="email-info">
      &copy; 2026 KlikMart. All rights
      reserved.
    </div>
  </div>
</body>
